...
#          uri: http://localhost:8081/
          ...
          filters: # 필터 적용
#            - AddRequestHeader=first-request, first-request-header => request 헤더에 first-request라는 이름으로 first-request-header라는 값을 저장
#            - AddResponseHeader=first-response, first-response-header => response 헤더에 first-response라는 이름으로 first-response-header라는 값을 저장
        ...
        return builder.routes()
                .route(r ->
                        ...
                        .filters(f -> // 필터를 적용할 때 사용
                                f.addRequestHeader("first-request", "first-request-header") // request 헤더에 first-request라는 이름으로 first-request-header라는 값을 저장
                                .addResponseHeader("first-response", "first-response-header")) // response 헤더에 first-response라는 이름으로 first-response-header라는 값을 저장
